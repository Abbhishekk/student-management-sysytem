...
<nav id="header" class="fixed w-full z-30 top-0 text-white gradient">
            ...
            <section class="bg-white py-8 container mt-10 ">
                <div class="md:flex no-wrap md:mx-2 ">
                    <!-- Left Side -->
                    <div class="m-10 w-full md:w-3/12 mx-2 ">
                    ...
                    <!-- Right Side -->
                    <div class="w-full md:w-9/12 mx-2 md:h-6">
                            ...
                            <?php 
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    if(mysqli_num_rows($result) == 1){
                                        ...
                                        echo "<p class='text-black'>No student found</p>";
                                        $res = null;
                                    }
                                }
                            ...
                            <div class="text-gray-700">
                                <div class="grid md:grid-cols-2 text-md">
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <?php if($res != null){?>
                                        <div class="px-4 py-2"><?php echo $res['age'] ?></div>
                                        <?php } else {?>
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <?php if($res != null){?>
                                            <div class="px-4 py-2"><?php echo $res['mobile'] ?></div>
                                            <?php } else {?>
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <?php if($res != null){?>
                                        <div class="px-4 py-2"><?php echo $res['course_name'] ?></div>
                                        <?php } else {?>
                                    ...
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold">Fees</div>
                                        <?php if($res != null){?>
                                        <div class="px-4 py-2"><?php echo $res['course_fees'] ?></div>
                                        <?php } else {?>
                                    ...
                                    <div class="grid grid-cols-2">
                                        <div class="px-4 py-2 font-semibold">Balance fees</div>
                                        <?php if($res != null){?>
                                        <div class="px-4 py-2"><?php echo $res['balance_fees'] ?></div>
                                        <?php } else {?>
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <?php if($res != null){?>
                                        <div class="px-4 py-2"><?php echo $res['date_of_joining'] ?></div>
                                        <?php } else {?>
                                    ...
                                    <div class="grid grid-cols-2">
                                        ...
                                        <?php if($res != null){?>
                                        <div class="px-4 py-2"><?php echo ($res['status'])?"active":"inactive" ?></div>
                                        <?php } else {?>
            ...
            <footer class="bottom-0 gradient top-0">
