        ...
        <li class="w-full h-full py-3 px-2 border-b border-300-border ">
            ...
            <main class="bg-white-500 flex-1 p-3 overflow-hidden">
                ...
                <div class="m-10">
                    ...
                    <h1 class="text-2xl mb-6 mt-0 ml-10 font-bold">Edit student details</h1>
                    <?php 
                        if (isset($_POST['edit'])) {
                            $id = $_POST['id'];
                            $name = $_POST['name'];
                    ...
                    <form action="edit_s.php" method="POST">
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <input type="text" name="name" id="name" value="<?php echo $user['name']?>" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="age" id="age" value="<?php echo $user['age']?>" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="number" name="mobile" id="mobile" value="<?php echo $user['mobile']?>" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="school" id="school" value="<?php echo $user['school_name']?>" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                            ...
                            <select name="course" id="course" class="block pt-4 pb-0 px-0 w-full text-l text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer">
                                ...
                                if (mysqli_num_rows($c) > 0) {
                                    while ($res = mysqli_fetch_assoc($c)) {
                                        if($res['course_name'] == $user['course_name']){
                                    ?>
                                    <option value="<?php echo $res['course_name'];?>" class="p-10 flex justify-around m-10 text-sm" selected><?php echo $res['course_name'];?></option>
                                <?php 
                                    }
                                    else{ ?>
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text"  name="fees" id="fees" value="<?php echo $user['course_fees']?>" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="text" name="aadhar" value="<?php echo $user['aadhar']?>" id="aadhar" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            <input type="date" name="date" value="<?php echo $user['date_of_joining']?>" id="date" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                        ...
                        <button type="submit" name="edit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Edit</button>
                    </form>
