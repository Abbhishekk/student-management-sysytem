                        ...
                        <?php
                            ...
                            if(isset($_POST['delete'])){
                                ...
                                if(!empty($_POST['ids'])){
                                    foreach($_POST['ids'] as $checked){
                                      ...
                                      $delete = $fun->getWorkingInternsById($checked);
                                        if($delete){
                                            echo "deleted";
                            ...
                            if(isset($_POST['complete'])){
                                ...
                                if(!empty($_POST['ids'])){
                                    ...
                                    foreach($_POST['ids'] as $checked ){
                                      ...
                                      $res = $fun->updateWorkingStatus(0,$checked);
                                        if($res){
                                            if(isset($_POST['CID'])){
                                                $cid = $_POST['CID'];
                                                $fun->updateWorkingIntern($cid[$i],$checked);
                                                $i++;
                                            }
                            ...
                            if(isset($_POST['submit'])){
                                ...
                                $limit = 10;  
                                    ...
                                    $sr = $start_from+1;
                                    $result = $fun->getWorkingWithLimit($start_from,$limit);
                            }
