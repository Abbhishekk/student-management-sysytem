                    ...
                    <div class="m-10">
                     ...
                     <?php
                            ...
                            if(isset($_POST['deposit'])){
                                ...
                                if($balance>=$remain){
                                    $deposit = "UPDATE `stud_details` SET `balance_fees`='".($balance-$remain)."' WHERE `id` = ".$d_id."";
                                    if(mysqli_query($conn,$deposit)){
                                        echo "Done!";
                                    ...
                                    $transaction = "INSERT INTO `transaction_history`( `user_id`, `name`, `amount`, `reason`) VALUES ('".$d_id."','".$_POST['name']."','".$remain."','course_fees')";
                                    ...
                                    if($row_earn > 0){
                                        ...
                                        if($subm < $month){
                                            ...
                                            if(mysqli_query($conn,$earning)){
                                                ...
                                                $remain += $earn['earning'];
                                                $earning = "UPDATE `earning` SET `earning`='".$remain."' WHERE `id`='".$earn['id']."'";
                                                mysqli_query($conn,$earning);
